  ...
  Widget build(BuildContext context) {
    ...
    if (error) {
      return Scaffold(
        ...
        body: Center(child: Text('Failed to load quizzes')),
      );
    }
                ...
                onTap: () async {
                  try {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            QuizPage(quizName: quiz['quizname']),
                      ),
                    );
                  } catch (e) {
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () => QuizUtilities.checkAnswer(1, nextQuestion),
              child: Text(
                q['opa'],
            ...
            ElevatedButton(
              ...
              onPressed: () => QuizUtilities.checkAnswer(2, nextQuestion),
              child: Text(
                q['opb'],
                style: TextStyle(fontSize: 28, color: Colors.black),
              ),
            ...
            ElevatedButton(
              ...
              onPressed: () => QuizUtilities.checkAnswer(3, nextQuestion),
              child: Text(
                q['opc'],
                style: TextStyle(fontSize: 28, color: Colors.black),
              ),
            ...
            ElevatedButton(
              ...
              onPressed: () => QuizUtilities.checkAnswer(4, nextQuestion),
              child: Text(
                q['opd'],
                style: TextStyle(fontSize: 28, color: Colors.black),
              ),
